...
time_in_seconds = 20
def soft(minPrice,maxPrice,cityList,vip_or_not,mail):
    while True:

        url = f"https://www.mymarket.ge/ka/search/getproducts"
        payload = f"PriceFrom={minPrice}&PriceTo={maxPrice}&CatID=53"
        headers = {
            ...
            'Referer': 'https://www.mymarket.ge/ka/search/53/iyideba-Laptop-kompiuterebi/?CatID=53',
        ...
        Thumbnail_info.retrieve_data(my_data, cityList, vip_or_not,mail)
